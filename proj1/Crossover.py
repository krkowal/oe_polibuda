...
class Crossover:
    ...
    def cross(self, chromosome_with_values_list):
        current_chromosomes_list = [chromosome for chromosome, value in chromosome_with_values_list]
    ...
    def _one_point_crossover(self, chromosome_list: List[Chromosome]):
        return self.__n_point_crossover(chromosome_list, 1)

    def _two_point_crossover(self, chromosome_list):
        return self.__n_point_crossover(chromosome_list, 2)

    def __n_point_crossover(self, chromosome_list: List[Chromosome], n):
        new_genes_first = []
        new_genes_second = []
    ...
    def _uniform_crossover(self, chromosome_list):
        new_genes_first = []
        new_genes_second = []
        first_chromosome = chromosome_list[0]
        second_chromosome = chromosome_list[1]
    ...
    def _discrete_crossover(self, chromosome_list):
        new_genes = []
        first_chromosome = chromosome_list[0]
        second_chromosome = chromosome_list[1]
        for gene_one, gene_two in zip(first_chromosome.get_genes_list(), second_chromosome.get_genes_list()):
